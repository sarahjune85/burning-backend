...
p1 = Airplane.create :name => '757', :row => '1', :col => 'A'
p2 = Airplane.create :name => '747', :row => '13', :col => 'B'
p3 = Airplane.create :name => '727', :row => '21', :col => 'C'
p4 = Airplane.create :name => '757', :row => '14', :col => 'A'
p5 = Airplane.create :name => '727', :row => '25', :col => 'D'
